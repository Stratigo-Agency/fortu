    ...
    <div class="mx-auto px-4 md:px-16 py-16">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-1">
          ...
          <p class="text-fortu-light text-sm leading-relaxed mb-6">
            {{ settings?.tagline || 'Empowering businesses with seamless digital solutions and premium experiences.' }}
          </p>
          <!-- Social Links -->
          <div class="flex gap-4">
            ...
            <a 
              ...
              class="w-10 h-10 rounded-full bg-fortu-medium/20 flex items-center justify-center hover:bg-fortu-off-white hover:text-fortu-dark transition-all duration-300" 
              aria-label="Twitter"
            >
        ...
        <div>
          ...
          <ul class="space-y-4">
            ...
            <li v-if="settings?.phone" class="flex gap-3">
              <svg class="w-5 h-5 text-fortu-light flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
              </svg>
              <a :href="`tel:${settings.phone}`" class="text-fortu-light hover:text-fortu-off-white transition-colors text-sm">
                {{ settings.phone }}
              </a>
            </li>
            <!-- WhatsApp -->
            <li v-if="settings?.whatsapp" class="flex gap-3">
              <svg class="w-5 h-5 text-fortu-light flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a :href="`https://wa.me/${settings.whatsapp.replace(/[^0-9]/g, '')}`" target="_blank" rel="noopener noreferrer" class="text-fortu-light hover:text-fortu-off-white transition-colors text-sm">
                {{ settings.whatsapp }}
              </a>
            </li>
            <!-- Email -->
            <li v-if="settings?.email" class="flex gap-3">
              ...
              <a :href="`mailto:${settings.email}`" class="text-fortu-light hover:text-fortu-off-white transition-colors text-sm">
                {{ settings.email }}
              </a>
            </li>
          </ul>
