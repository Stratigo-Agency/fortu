<template>
  <section v-if="productSlides && productSlides.length > 0 && !loading" class="product-slides-section relative min-h-screen md:h-[95vh] bg-fortu-off-white overflow-hidden">
        ...
        >
          ...
          <div class="flex flex-col h-full md:hidden pb-6">
            ...
            <div class="bg-fortu-off-white px-6 pt-20 pb-6">
              ...
              <!-- Feature Tags -->
              <div v-if="product.features && product.features.length > 0" class="flex flex-wrap gap-2">
                <span 
          ...
          <div class="hidden md:flex absolute inset-0 z-10 flex-col justify-between p-16">
            <!-- Top Section -->
            <div class="max-w-xl pt-24">
              ...
              <div v-if="product.features && product.features.length > 0" class="flex flex-wrap gap-2">
                <span 
                  ...
                  class="inline-flex items-center gap-1.5 px-3 py-1.5 font-medium bg-fortu-off-white backdrop-blur-sm rounded-full text-fortu-dark text-md"
                >
            ...
            <div class="flex items-end justify-between">
              ...
              <div class="flex gap-2">
                <button
                  @click="prevSlide"
                  class="w-12 h-12 text-fortu-dark rounded-full bg-fortu-off-white/80 backdrop-blur-sm flex items-center justify-center hover:bg-fortu-dark hover:text-fortu-off-white transition-all duration-300"
                  aria-label="Previous slide"
                >
    ...
    <div class="absolute bottom-0 left-0 right-0 h-1 bg-fortu-light/20">
      <div 
